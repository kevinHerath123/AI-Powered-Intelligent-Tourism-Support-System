...
# Install dependencies using Python syntax (works in Streamlit/PyCharm)
subprocess.check_call([sys.executable, "-m", "pip", "install", "tensorflow", "opencv-python", "pillow", "matplotlib"])
